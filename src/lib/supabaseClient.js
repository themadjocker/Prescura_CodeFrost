// Mock Supabase Client for Demo/Hackathon (module version)
...
let MOCK_PATIENTS_DB = [
  {
    ...
    problem: "Fatigue",
    protocols: [
      { name: "Vitamin Complex", freq: "1-0-0", duration: "30 days", notes: "Daily" }
    ],
    urgency: "Low",
...
export const getCommonProblems = () => COMMON_HEALTH_PROBLEMS;
